...
#define MUSART_DIV_SAMPLING16(_PCLK_, _BAUD_)            ((u32)((((u64)(_PCLK_))*25U)/(4U*((u64)(_BAUD_)))))
#define MUSART_DIVMANT_SAMPLING16(_PCLK_, _BAUD_)        (MUSART_DIV_SAMPLING16((_PCLK_), (_BAUD_))/100U)
#define MUSART_DIVFRAQ_SAMPLING16(_PCLK_, _BAUD_)        ((((MUSART_DIV_SAMPLING16((_PCLK_), (_BAUD_)) - (MUSART_DIVMANT_SAMPLING16((_PCLK_), (_BAUD_)) * 100U)) * 16U) + 50U) / 100U)
/* UART BRR = mantissa + overflow + fraction
            = (UART DIVMANT << 4) + (UART DIVFRAQ & 0xF0) + (UART DIVFRAQ & 0x0FU) */
#define MUSART_BRR_SAMPLING16(_PCLK_, _BAUD_)            ((MUSART_DIVMANT_SAMPLING16((_PCLK_), (_BAUD_)) << 4U) + \
                                                        (MUSART_DIVFRAQ_SAMPLING16((_PCLK_), (_BAUD_)) & 0xF0U) + \
                                                        (MUSART_DIVFRAQ_SAMPLING16((_PCLK_), (_BAUD_)) & 0x0FU))

#define MUSART_DIV_SAMPLING8(_PCLK_, _BAUD_)             ((u32)((((u64)(_PCLK_))*25U)/(2U*((u64)(_BAUD_)))))
#define MUSART_DIVMANT_SAMPLING8(_PCLK_, _BAUD_)         (MUSART_DIV_SAMPLING8((_PCLK_), (_BAUD_))/100U)
#define MUSART_DIVFRAQ_SAMPLING8(_PCLK_, _BAUD_)         ((((MUSART_DIV_SAMPLING8((_PCLK_), (_BAUD_)) - (MUSART_DIVMANT_SAMPLING8((_PCLK_), (_BAUD_)) * 100U)) * 8U) + 50U) / 100U)
/* UART BRR = mantissa + overflow + fraction
            = (UART DIVMANT << 4) + ((UART DIVFRAQ & 0xF8) << 1) + (UART DIVFRAQ & 0x07U) */
#define MUSART_BRR_SAMPLING8(_PCLK_, _BAUD_)             ((MUSART_DIVMANT_SAMPLING8((_PCLK_), (_BAUD_)) << 4U) + \
                                                        ((MUSART_DIVFRAQ_SAMPLING8((_PCLK_), (_BAUD_)) & 0xF8U) << 1U) + \
                                                        (MUSART_DIVFRAQ_SAMPLING8((_PCLK_), (_BAUD_)) & 0x07U))
