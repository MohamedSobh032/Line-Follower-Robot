...
#define MADC_CLOCK_PRESCALER				MADC_CLK_DIV_BY_2
...
#define MADC_SCANNING_MODE					MADC_SCAN_CONVERSION_MODE

#if MADC_SCANNING_MODE == MADC_SCAN_CONVERSION_MODE
	#define MADC_END_OF_CONVERSION_LOCATION		MADC_EOC_REGULAR_CONVERSION_END
#endif
